    ...
    <div className={`min-h-screen flex relative ${isDarkMode ? 'bg-[#181f2a]' : 'bg-gray-50'}`}>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <button
          ...
          className={`absolute z-30 left-0 top-14 md:top-15 w-10 h-10 flex items-center justify-center rounded-full border-2 border-purple-500 hover:border-purple-400 transition-all duration-200 shadow-lg ${
